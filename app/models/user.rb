class User < ApplicationRecord
  ...
  has_many :connector_relations, foreign_key: "connectee_id", class_name: "Connection"
  ...
  has_many :connectee_relations, foreign_key: "connector_id", class_name: "Connection"
